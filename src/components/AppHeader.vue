...
export default {
    data() {
        return {
            ...
            author: {
                img: "avatar.jpg",
                description: "lorem ipsium si namet, bing chilling, bruh , niverra esumado pelle, poltrone sofa, conscutor e baby Yoda,",
                name: "John Doe"
            },
            featured: {
                img: "blog-66(1).jpg",
...
<template>
    <header>
        ...
        <!-- nav -->
        <section class="nav fl">
            <div class="wrapper">
                <nav class="fl j-between ">
                    <ul>
...
.logo {
    padding: 2rem 0;
    border-bottom: 1px solid $bd-gray1;
